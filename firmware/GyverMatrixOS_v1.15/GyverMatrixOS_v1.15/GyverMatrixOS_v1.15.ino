...
uint16_t CURRENT_LIMIT=1000;  // лимит по току в миллиамперах, автоматически управляет яркостью (пожалей свой блок питания!) 0 - выключить лимит
...
const byte ALARM_LIST_IDX[] PROGMEM = {EFFECT_SNOW, EFFECT_BALL, EFFECT_RAINBOW, EFFECT_PAINTBALL, EFFECT_FIRE, EFFECT_MATRIX, EFFECT_BALLS,
                                       ...
                                       EFFECT_PRISMATA, EFFECT_MUNCH, EFFECT_METABALLS, EFFECT_SINUSOID, EFFECT_FIRE_2012,EFFECT_R_SNAKE, EFFECT_DAWN_ALARM, EFFECT_ANIMATION_1
